            ...
            <div className="space-y-4">
              {loading ? (
                ...
                dashboardData.alerts.map((alert: any, index: number) => {
                  type AlertColor = 'red' | 'yellow' | 'orange' | 'blue' | 'green';
                  const color = (['red','yellow','orange','blue','green'].includes(alert.color) ? alert.color : undefined) as AlertColor | undefined;
                  const colorClasses = {
